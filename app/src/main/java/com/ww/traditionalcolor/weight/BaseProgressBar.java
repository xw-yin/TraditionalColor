package com.ww.traditionalcolor.weight;
...
import com.ww.traditionalcolor.R;
...
public class BaseProgressBar extends View {
    ...
    public BaseProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mIfDrawText = a.getBoolean(R.styleable.CustomProgressBar_text_visibility, true);
        if (mIfDrawText) {
            mTextOffset = a.getDimension(R.styleable.CustomProgressBar_text_offset, default_progress_text_offset);
            mTextColor = a.getColor(R.styleable.CustomProgressBar_text_color, DEFAULT_TEXT_COLOR);
            mTextSize = a.getDimension(R.styleable.CustomProgressBar_text_size, default_text_size);
            mPrefix = a.hasValue(R.styleable.CustomProgressBar_prefix) ? a.getString(R.styleable.CustomProgressBar_prefix) : "";
            mSuffix = a.hasValue(R.styleable.CustomProgressBar_suffix) ? a.getString(R.styleable.CustomProgressBar_suffix) : "";
        }

        mMaxProgress = a.getInt(R.styleable.CustomProgressBar_max, 100);
        mShownProgress = mActualProgress = a.getInt(R.styleable.CustomProgressBar_progress, 0);
