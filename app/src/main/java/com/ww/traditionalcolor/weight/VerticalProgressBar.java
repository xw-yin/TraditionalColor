...
public class VerticalProgressBar extends BaseProgressBar {
    ...
    public VerticalProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mReachedBarWidth = a.getDimension(R.styleable.CustomProgressBar_reached_bar_width, default_reached_bar_width);//default_reached_bar_width;
        mUnreachedBarWidth = a.getDimension(R.styleable.CustomProgressBar_unreached_bar_width, default_unreached_bar_width);//default_unreached_bar_width;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (width_mode == View.MeasureSpec.EXACTLY) {
